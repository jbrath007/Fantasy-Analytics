...
plt.savefig("qb_fantasy_points.png", bbox_inches='tight')
#plt.show()

#print("QB Fantasy Points Plot Saved as qb_fantasy_points.png")

data_frame_stats = pd.concat([qb_stats, rb_stats, wr_stats, te_stats], ignore_index=True)

data_frame_stats = data_frame_stats.fillna(0)